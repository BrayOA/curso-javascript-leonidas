...
export default async function weeklyWeather() {
    ...
    const {isError: weeklytWeatherError, data:weather}  = await getWeeklyWeather (lat, lon)
    if (weeklytWeatherError) return console.log('oh! a ocurrido un error trayendo el pronostico del clima ')
